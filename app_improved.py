...
# Arquivo para salvar planilha mãe
PLANILHA_MAE_FILE = "planilha_mae_fixa.pkl"
ESTOQUE_FILE = "estoque.pkl"
HISTORICO_VENDAS_FILE = "historico_vendas.pkl"
VENDAS_PROCESSADAS_FILE = "vendas_processadas.pkl"
...
# Verifique se a planilha mãe existe
    ...
    if produtos_lista:
        ...
        if selected_items:
            ...
            if st.button("Adicionar/Atualizar Estoque"):
                if quantidade != 0:
                    # Buscar dados do produto na planilha mãe
        ...
        st.info("Carregue a Planilha Mãe primeiro para gerenciar o estoque")
